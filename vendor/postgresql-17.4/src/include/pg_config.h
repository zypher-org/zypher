...
#define CONFIGURE_ARGS " '--without-readline' '--without-icu' '--without-gssapi' '--without-ldap' '--without-pam' '--without-selinux' '--without-perl' '--without-python' '--without-tcl'"
...
#define PG_VERSION_STR "PostgreSQL 17.4 on x86_64-pc-linux-gnu, compiled by gcc (GCC) 16.1.1 20260625, 64-bit"
