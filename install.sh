...
install_zig() {
  ...
  download "https://ziglang.org/builds/$zig_archive_name" "$zig_archive"
  zig_sums="$tmp_zig/sha256sums.txt"
  download "https://ziglang.org/builds/sha256sums.txt" "$zig_sums"
  verify_sha256 "$zig_archive" "$zig_sums"
